  ...
  return (
    <div className="login-container">
      <div className="content-container">
        {/* <h2 className="text-3xl font-bold mb-4 text-center text-[#ea580c]">
          Hot Courier Services
        </h2> */}
        <div className="w-full flex justify-center"><img src={Logo} alt="Logo" className="logo mr-4 " style={{width: "10rem"}}/></div>
